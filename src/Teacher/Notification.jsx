...
const Notification = () => {
  ...
  const notifications = [
    { title: 'New Application', description: 'You have a new application for your project.', time: '1 day ago' },
    { title: 'Project Update', description: 'A student has updated their application.', time: '2 hours ago' },
    { title: 'Important Reminder', description: 'Don’t forget to review the student applications by end of day.', time: '30 minutes ago' },
  ];
